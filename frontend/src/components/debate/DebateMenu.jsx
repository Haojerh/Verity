    ...
    <div className="absolute top-4 right-4">
      ...
      {open && (
        <div className="absolute right-0 top-8 mt-2 w-40 bg-white border rounded-lg shadow-lg">
          <button className="flex gap-2 p-3 w-full hover:bg-gray-100 items-center">
            <Bookmark className="w-4 h-4"/> Save
          </button>
          <button className="flex gap-2 p-3 w-full text-red-500 hover:bg-gray-100 items-center">
