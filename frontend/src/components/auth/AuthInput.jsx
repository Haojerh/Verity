...
export default function AuthInput({
  ...
  return (
    <div className="flex flex-col">
      {label && (
        <label className="text-sm font-medium text-foreground ml-1 mb-2">
          {label}
        </label>
      )}
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${
            Icon ? "pl-10" : "px-4"
          } pr-10 py-2.5 bg-background border rounded-xl focus:outline-none focus:ring-2 transition-all text-sm text-foreground ${
            error
