...
public class ReportService {
    ...
    public void createReport(ReportRequest request) {
        ...
        UserEntity reporter = userRepo.findUserByEmail(email)
        ...
        if ("POST".equalsIgnoreCase(request.getType())) {
            ...
            throw new RuntimeException("Invalid report type. Use POST or COMMENT.");
        }
    ...
    public List<ReportDTO> getAllReports() {
        return reportRepo.findBySYSISDELETEDFalse()
                .stream()
